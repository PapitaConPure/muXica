 ...
 * @param {String} long_message
 */
function __audio_error(message, long_message = "No additional information was provided for this error") {
	throw {
...
#macro MUX_CHECK_UNINITIALISED_EX if MUX_CHECK_UNINITIALISED then __audio_error(MUX_EX_UNINITIALISED)
#macro MUX_CHECK_UNINITIALISED_EX_OR_FALSE if MUX_CHECK_UNINITIALISED { if MUX_EX_ENABLE then __audio_error(MUX_EX_UNINITIALISED) else return false; }
...
#macro MUX_CHECK_INVALID_EX if MUX_CHECK_INVALID then __audio_error(MUX_EX_INVALID)