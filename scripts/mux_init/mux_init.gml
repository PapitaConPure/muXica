...
function __mux_init() {
	...
	global.__mux_time_source_boot = time_source_create(time_source_global, 1, time_source_units_frames, mux_persist, [], -1);
	time_source_start(global.__mux_time_source_boot);
}
