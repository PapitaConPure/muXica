...
#macro MUX_WARN_ENABLE true

//Make the system more strict to make debugging easier
//Can be disabled if you're super super sure nothing will go wrong
#macro MUX_EX_ENABLE true
