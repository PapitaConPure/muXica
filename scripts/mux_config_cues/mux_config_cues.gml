...
//Each cue is associated to the provided sound asset index
...
function mux_config_cues() {
	...
	//mux_cue_set(aud_bgm_test2, "intro",        0);
	//mux_cue_set(aud_bgm_test2, "verse1 start", mux_time_get_beat_pos( 4, 148, 0.147));
	//mux_cue_set(aud_bgm_test2, "verse2 end",   mux_time_get_beat_pos( 8, 148, 0.147));
	//mux_cue_set(aud_bgm_test2, "verse2 start", mux_time_get_beat_pos(12, 148, 0.147));
	//mux_cue_set(aud_bgm_test2, "verse3 end",   mux_time_get_beat_pos(16, 148, 0.147));
}
